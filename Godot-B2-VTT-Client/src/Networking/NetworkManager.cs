...
public class NetworkManager : Node2D
{
	private readonly int defaulPort = 4321;
	...
	public void HostGame()
	{
		...
		peer.CreateServer(defaulPort, 32);
	...
	public void JoinGame()
	{
		...
		var result = clientPeer.CreateClient(address, defaulPort);
	...
	{
		// load the players
		var playerScene = (PackedScene)ResourceLoader.Load("res://objects/Player.tscn");
